...
<gameSystem id="84d12e6f-091a-686e-2850-cd6013115292" revision="1" battleScribeVersion="1.14b" name="Robotech RPG Tactics" authorName="Eric Falsken" authorUrl="https://github.com/BSData/robotech-rpg-tactics" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <forceTypes>
  ...
  <profileTypes>
    <profileType id="6080e3d0-8384-2d92-c98b-b8fcb39fa768" name="Mecha">
      <characteristics>
        ...
        <characteristic id="cfe5dd88-98dc-7ea2-4289-b90fd40a9e1b" name="Description"/>
      </characteristics>
    </profileType>
